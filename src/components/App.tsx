import s from '../style/components/App.module.scss';
    ...
    return (
        <div className={s.app}>
            <header className={s.app__header}>
                    <svg className={s.app__logo} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 841.9 595.3">
                        <g fill="#61DAFB">
                            <path
            ...
            <footer className={s.app__footer}>
                <a href={'https://t.me/kravtsov_ilia'} className={s.getHireLink} target={'_blank'} rel="noreferrer">
                    <div className={s.getHireLink__container}>
                        <div className={s.getHireLink__title}>
